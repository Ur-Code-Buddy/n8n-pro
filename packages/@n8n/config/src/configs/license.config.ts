...
export class LicenseConfig {
	...
	/**
	 * When enabled, unlocks all licensed features and quotas without a paid license.
	 * Set N8N_LICENSE_UNLOCK_ALL=false to test against real license behavior.
	 */
	@Env('N8N_LICENSE_UNLOCK_ALL')
	unlockAllFeatures: boolean = true;
}
